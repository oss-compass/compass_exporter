defmodule CompassAdminWeb.GiteeReposLive do
    ...
    <%= if live_flash(@flash, :error) == nil do %>
        ...
        <form phx-change="search" class="mb-2 float-left">
          <span>
            ...
            <.button
              ...
              to={"/admin/gitee/repos/bulk?page=#{@meta[:current_page]}&query=#{@meta[:query]}&search_mode=#{@search_mode}"}
              label="Bulk"
            />
          </span>
        </form>
      ...
      <div class="flex justify-center">
        <.pagination
          ...
          path={
            fn page ->
              "/admin/gitee/repos?page=#{page}&query=#{@meta[:query]}&search_mode=#{@search_mode}"
            end
          }
  ...
  defp cached_url(socket, query \\ nil, page \\ nil, search_mode \\ nil, suffix \\ "") do
    ...
    "/admin/gitee/repos/#{suffix}?page=#{cached_page}&query=#{query}&search_mode=#{search_mode}"
  end
