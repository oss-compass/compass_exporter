...
if System.get_env("PHX_SERVER") && System.get_env("RELEASE_NAME") do
  config :compass_admin, CompassAdmin.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :compass_admin, CompassAdminWeb.Endpoint, server: true
  #
  ...
  #
  #     config :compass_admin, CompassAdmin.Mailer,
